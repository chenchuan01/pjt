...
public class WebBootStrap {
	...
	private static final String PROJECT_NAM = "pjt-web";

	private static final String WEB_SRC = PROJECT_NAM + "/src/main/webapp";

	private final Logger logger = LoggerFactory
			.getLogger(WebBootStrap.class);

	public WebBootStrap(String webappPath, int port, String context) {
	...
	private static String getResultPath() {
		String path = WebBootStrap.class.getResource(SEPARATOR_CHAR_SLASH).getPath();
		String webPath = path.substring(1, path.indexOf(PROJECT_NAM)) + WEB_SRC;
		return "/"+webPath;
	}

	public static void main(String[] args) {
		new WebBootStrap(getResultPath(), 8098, "//").start();
	}
}
